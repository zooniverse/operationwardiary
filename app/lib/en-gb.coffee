PROJECT_NAME = 'Diaries of the First World War'
...
module.exports =
  ...
  activities:
    ...
    movement_1: 'Movement: by vehicle'
    movement_2: 'Movement: by train'
    movement_3: 'Movement: by marching'
    training: 'Training'
    fire: 'Under fire '
    attack: 'Attacking'
    raid: 'Raiding'
    ...
    quiet: 'All quiet'
    artillery: 'Artillery '
    enemy_movement: 'Enemy activity: movement'
  ...
  person:
    ...
    returned_1: 'Returned: from hospital'
    returned_2: 'Returned: from leave'
    returned_3: 'Returned: from training'
    casualty_1: 'Casualty: Died of Wounds'
    casualty_2: 'Casualty: Wounded'
    casualty_3: 'Casualty: Killed in Action '
    casualty_4: 'Casualty: Prisoner of War'
    award_1: 'Award: DSO'
    award_2: 'Award: VC'
    promotion: 'Promoted'
    combat: 'Combat'
